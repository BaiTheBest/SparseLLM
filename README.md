...
This repository contains the code for our **NeurIPS 2024** paper "[*SparseLLM*: Towards Global Pruning for Pre-trained Language Models](https://arxiv.org/abs/2402.17946)". We are actively working on further improving the numerical stability of the code and incorporating more model types and functionalities. 
